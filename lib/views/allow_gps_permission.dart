...
class AllowGpsPermissionView extends StatefulWidget {
  ...
  @override
  AllowGpsPermissionViewState createState() => AllowGpsPermissionViewState();
}

class AllowGpsPermissionViewState extends State<AllowGpsPermissionView> {
  late Timer _timer;
  bool status = false;
                  ...
                  child: Container(
                    ...
                    child: ClipRRect(
                        ...
                        child: Container(
                            ...
                            child: const Image(
                                image:
                                    AssetImage('assets/images/enable.png')))),
                  ),
                ),
              ),
                ...
                child: ElevatedButton(
                    style: ElevatedButton.styleFrom(
                        padding: const EdgeInsets.symmetric(
                            vertical: 15, horizontal: 35), backgroundColor: const Color.fromRGBO(62, 204, 191, 1),
                        elevation: 0,
