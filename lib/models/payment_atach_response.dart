...
//
//     final paymentAtach = paymentAtachFromJson(jsonString);

import 'dart:convert';

PaymentAtach paymentAtachFromJson(String str) => PaymentAtach.fromJson(json.decode(str));

String paymentAtachToJson(PaymentAtach data) => json.encode(data.toJson());

class PaymentAtach {
    PaymentAtach({
        required this.paymentMethodAttach,
    });

    PaymentMethodAttach paymentMethodAttach;

    factory PaymentAtach.fromJson(Map<String, dynamic> json) => PaymentAtach(
        paymentMethodAttach: PaymentMethodAttach.fromJson(json["paymentMethodAttach"]),
    );

    Map<String, dynamic> toJson() => {
        "paymentMethodAttach": paymentMethodAttach.toJson(),
    };
}

class PaymentMethodAttach {
    PaymentMethodAttach({
        required this.id,
    ...
    factory PaymentMethodAttach.fromJson(Map<String, dynamic> json) => PaymentMethodAttach(
        id: json["id"],
        object: json["object"],
