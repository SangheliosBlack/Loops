...
GoogleDirections googleDirectionsFromJson(String str) => GoogleDirections.fromJson(json.decode(str));

String googleDirectionsToJson(GoogleDirections data) => json.encode(data.toJson());
...
class GoogleDirections {
    ...
    factory GoogleDirections.fromJson(Map<String, dynamic> json) => GoogleDirections(
