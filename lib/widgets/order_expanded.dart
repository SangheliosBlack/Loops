...
/// [OrderWidgetExpanded] to save and restore its expanded state when it is scrolled
/// in and out of view.
///
...
/// to the [leading] and [trailing] properties of [OrderWidgetExpanded].
///
/// {@tool dartpad}
...
class OrderWidgetExpanded extends StatefulWidget {
  /// Creates a single-line [ListTile] with an expansion arrow icon that expands or collapses
  /// the tile to reveal or hide the [children]. The [initiallyExpanded] property must
  /// be non-null.
  const OrderWidgetExpanded({
    Key? key,
    this.leading,
    required this.title,
    this.subtitle,
  ...
  @override
  State<OrderWidgetExpanded> createState() => _OrderWidgetExpandedState();
}

class _OrderWidgetExpandedState extends State<OrderWidgetExpanded>
